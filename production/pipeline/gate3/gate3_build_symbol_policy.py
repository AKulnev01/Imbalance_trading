...
def parse_runtime_args():
    ...
    parser.add_argument("--in-edge", default=IN_EDGE)
    parser.add_argument("--out-policy", default=OUT_POLICY)
    parser.add_argument("--strong-score", type=float, default=STRONG_SCORE)
...
def apply_runtime_args(args) -> None:
    ...
    IN_EDGE = str(args.in_edge)
    OUT_POLICY = str(args.out_policy)
    STRONG_SCORE = float(args.strong_score)


def main() -> None:
    print("Gate3 Build Symbol Policy")
