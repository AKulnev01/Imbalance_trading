...
DATA = Path("reports/features/bonk_v12_weighted.parquet")
OUT  = Path("models/bonk_v12_weighted.cbm")
...
X_train, y_train, w_train = df[feature_cols].iloc[:split], y.iloc[:split], w.iloc[:split]
